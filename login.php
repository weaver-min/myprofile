<?php
session_start();
/* - すでにログインしている場合はトップページにリダイレクトする
 - POSTリクエストの場合は、ユーザーIDとパスワードを検証する
 - 検証に成功した場合はセッションにユーザー情報を保存してトップページにリダイレクトする
 - 検証に失敗した場合はエラーメッセージを表示する
*/
      ...
      <div class="login-card-body">
        ...
        <form action="login.php" method="post">
          <div class="form-group">
            ...
            <input type="text" id="login-id" name="login_id" class="form-control" placeholder="ユーザーIDを入力"
              autocomplete="username">
          </div>
          <div class="form-group">
            <label class="form-label" for="login-pass">パスワード</label>
            <input type="password" id="login-pass" name="login_pass" class="form-control" placeholder="パスワードを入力"
