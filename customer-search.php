  ...
  <div class="main">
    <header class="topbar">
      <ol class="breadcrumb">
        ...
        <li><span class="current">顧客情報検索</span></li>
      </ol>
    ...
    <div class="content">
      <div class="page-header">
        <div>
          <div class="page-title">顧客情報検索</div>
          <div class="page-subtitle">条件を指定して顧客を検索します</div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-body">
          <form id="search-form" method="post" action="customer-search.php">
            <div class="form-grid">
              <div class="form-full">
              ...
              <div class="form-group">
                ...
                <select name="sex" class="form-control form-select"
                  ...
                  <option value="男"
                          <?php echo $values['sex'] === '男' ? 'selected' : ''; ?>>男</option>
                  <option value="女"
                          <?php echo $values['sex'] === '女' ? 'selected' : ''; ?>>女</option>
                </select>
              </div>
              <div class="form-group">
                ...
                <select name="group" class="form-control form-select"
                  ...
                  <option value="<?php echo htmlspecialchars($g); ?>"
                          <?php echo $values['group'] === $g ? 'selected' : ''; ?>>
                ...
                <div class="form-check-group">
                  <label>
                    <input type="checkbox" name="stop" value="1"
                           <?php echo $values['stop'] === '1' ? 'checked' : ''; ?>>
                    配信停止のみ表示
                  </label>
                </div>
              </div>
