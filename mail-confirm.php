...
// save to session for PRG pattern
$_SESSION['mail_data'] = [
    'send'  => $send,
    'title' => $title,
    'body'  => $body,
  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-section">
      ...
      <div class="nav-sub">
        ...
        <a href="mail-work.php" class="nav-item active"><svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>メール作成</a>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <div class="info-box" style="min-height:200px;white-space:pre-wrap;line-height:1.8;"><?= htmlspecialchars($body) ?></div>
        </div>
        ...
        <div class="form-footer">
          <button type="button" class="btn btn-ghost" onclick="history.back()">修正する</button>
          <!-- PRG: submit to mail-send.php with no body data, just trigger from session -->
