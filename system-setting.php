...
$success = '';
/* - POSTされたデータを受け取る
 - すべての項目が入力されているか、新しいパスワードが一致しているか、パスワードの長さが6文字以上であるかを検証する
 - 検証に失敗した場合はエラーメッセージをセットする
 - 検証に成功した場合は、現在のパスワードが正しいかをデータベースから取得して確認する
 - 現在のパスワードが正しい場合は、新しいパスワードをハッシュ化してデータベースに保存する
 - 保存後は成功メッセージをセットする
 - 現在のパスワードが正しくない場合はエラーメッセージをセットする
*/
...
<body>
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-section"><a href="system-setting.php" class="nav-item active"><svg class="nav-icon"
        ...
        <div class="card-body">
          ...
          <form action="system-setting.php" method="post">
            <div class="form-group">
              ...
              <input type="password" id="pass-current" name="pass_current" class="form-control"
                placeholder="現在のパスワードを入力" autocomplete="current-password">
            </div>
            <div class="form-group">
              <label class="form-label" for="pass-new">新しいパスワード</label>
              <input type="password" id="pass-new" name="pass_new" class="form-control" placeholder="新しいパスワードを入力"
                autocomplete="new-password">
            </div>
            <div class="form-group">
              <label class="form-label" for="pass-confirm">新しいパスワード（確認）</label>
              <input type="password" id="pass-confirm" name="pass_confirm" class="form-control"
                placeholder="新しいパスワードを再入力" autocomplete="new-password">
            </div>
